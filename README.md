...
- Fullscreen Now Playing overlay via `Ctrl+O` with auto-selected cover layouts, scrolling metadata, progress, status, and bordered clickable playback controls.
